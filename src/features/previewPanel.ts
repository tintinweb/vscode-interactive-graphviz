...
export default class PreviewPanel {
    ...
    constructor(uri: vscode.Uri, panel : vscode.WebviewPanel) {
      ...
      const renderLockAdditionalTimeout = vscode.workspace.getConfiguration('graphviz-interactive-preview').get('renderLockAdditionalTimeout') as number;
      const view_transitionDelay = vscode.workspace.getConfiguration('graphviz-interactive-preview').get('view.transitionDelay') as number;
      const view_transitionaDuration = vscode.workspace.getConfiguration('graphviz-interactive-preview').get('view.transitionDuration') as number;
